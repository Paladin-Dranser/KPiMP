...
public class LoginController extends HttpServlet {
	...
	private void login(HttpServletRequest request, HttpServletResponse response)
		...
		// Калі аўтэнтыфікацыя прайшла паспяхова (вярнуўся аб'екта класа Person)
		if (person != null) {			
			HttpSession session = request.getSession();
			
			// устанаўліваем дату аўтэнтыфікацыі для карыстальніка
			...
			// калі карыстальнік адміністратар, то запісваем у пераменную сесіі
			// іфармацыю пра ўсіх карыстальнікаў
