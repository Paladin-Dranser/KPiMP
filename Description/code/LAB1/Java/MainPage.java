...
public class MainPage extends HttpServlet {
	...
	// SQL запыты для атрымання інфармацыі з базы даных
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
        	// Калі не было ўведзена аніякіх імён,
        	// то выбіраем запыт для вяртання ўсіх карыстальнікаў з табліцы,
        	// інакш толькі тыя, што падыходзяць па крытэрыю
        	if (searchName != "") {
            ...
            // Дабаўляем атрыманыя запісы з табліцы ў ліст працаўнікоў
            while (result.next()) {
        ...
        // Запісваем атрыманых карыстальнікаў у параметры сесіі
        // вяртаем старонку з рэзультатам
